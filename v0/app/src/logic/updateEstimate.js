...
function updateEstimate(token, estimateId, {customer, estimateNumber, terms, estimateDate, products, totalAmount}){
    ...
    return (async() => {
        try{
            await axios.patch(`${API_URL}/estimates/${estimateId}`,
